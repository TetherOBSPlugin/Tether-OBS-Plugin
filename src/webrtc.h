...
typedef void (*tether_wrtc_local_sdp_cb_t)(void *user, const char *sdp_type,
					   const char *sdp);
typedef void (*tether_wrtc_local_ice_cb_t)(void *user, const char *candidate,
					   const char *mid, int mline_index);
typedef void (*tether_wrtc_state_cb_t)(void *user, tether_webrtc_state_t state);
typedef void (*tether_wrtc_video_cb_t)(void *user, const uint8_t *data, size_t size,
				       int64_t pts, int track_id);
typedef void (*tether_wrtc_audio_cb_t)(void *user, const uint8_t *data, size_t size,
				       int64_t pts, int track_id);
